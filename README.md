...
This module installs Opa-gatekeeper on Kubernetes.
...
The module bundles an upstream release of Opa-gatekeeper and makes it fully configurable with Kustomizations set as input attributes.
...
module "example_opa_gatekeeper" {
  providers = {
    kustomization = kustomization.local
  }

  source  = "kubestack-modules/opa-gatekeeper/kustomization"
